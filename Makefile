...
VERSION ?= $(shell git describe --tags --abbrev=0 2>/dev/null || echo "v0.4.5-alpha")
...
GO_SOURCES = version.go \
	...
	version_manager.go update_manager.go update_commands.go github_client.go update_checker.go update_downloader.go update_installer.go update_ui.go update_scheduler.go update_history.go update_validation.go update_channels.go update_channel_commands.go \
